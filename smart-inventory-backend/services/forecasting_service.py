...
# In-memory forecast cache keyed by (product_id, history_count)
_FORECAST_CACHE: Dict[tuple, Dict[str, Any]] = {}


def generate_forecast(db: Session, product_id: int, days: int = 7) -> Dict[str, Any]:
    ...
    # 3. Check Cache
    cache_key = (product_id, len(history))
...
def evaluate_forecast(
    db: Session, product_id: int, holdout_days: int = 30
) -> Dict[str, Any]:
